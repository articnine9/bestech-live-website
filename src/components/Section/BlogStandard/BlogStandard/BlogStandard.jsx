        ...
        <div className="row">
          <div className="col-xl-8">
            <div className="blog-standard-page__content">
              <div className="blog-standard-page__single">
                ...
                <div className="blog-standard-page__single-content">
                  <ul className="meta-box">
                    ...
                    <li>
                      <Link href="blog">
                        <i className="icon-date"></i> November 13, 2023
                      </Link>
                    </li>
                    <li>
                      <Link href="blog-details">
                        <i className="icon-comments"></i> 02 Comments
                      </Link>
                    </li>
                    <li>
                      <Link href="blog">
                        <i className="icon-tag"></i> Rail Transport
                      </Link>
                    </li>
                  </ul>
                  <h2>
                    <Link href="blog-details">
                      Rail Transport Service Functions by <br /> Bestech
                      Logister
                    </Link>
                  </h2>
                  <p>
              ...
              <div
                className={`blog-standard-page__single ${
                  popup ? "zindex-50" : "zindex-1"
                }`}
              >
                <style jsx>{`
                  .zindex-50 {
                ...
                <div className="blog-standard-page__single-content">
                  ...
                  <h2>
                    <Link href="blog-details">
                      Advanced Service Functions by <br /> Rail Transport
                      Service
                    </Link>
                  </h2>
                  <p>
              ...
              <div className="blog-standard-page__single">
                <div className="blog-standard-page__single-content">
                  ...
                  <ul className="meta-box style2">
                    ...
                    <li>
                      <Link href="blog">
                        <i className="icon-date"></i> April 30, 2023
                      </Link>
                    </li>
                    <li>
                      <Link href="blog-details">
                        <i className="icon-comments"></i> 06 Comments
                      </Link>
                    </li>
                    <li>
                      <Link href="blog">
                        <i className="icon-tag"></i> Logistic
                      </Link>
                    </li>
                  </ul>
                  <h2>
                    <Link href="blog-details">
                      Advanced Service Functions by <br /> Road Fraight
                    </Link>
                  </h2>
                  <p>
                    Packages and web page editors now use Lorem Ipsum as their
              ...
              <div className="blog-standard-page__single">
                ...
                <div className="blog-standard-page__single-content">
                  <ul className="meta-box">
                    ...
                    <li>
                      <Link href="blog">
                        <i className="icon-date"></i> February 28, 2023
                      </Link>
                    </li>
                    <li>
                      <Link href="blog-details">
                        <i className="icon-comments"></i> 04 Comments
                      </Link>
                    </li>
                    <li>
                      <Link href="blog">
                        <i className="icon-tag"></i> Ocean{" "}
                      </Link>
                    </li>
                  </ul>
                  <h2>
                    <Link href="blog-details">
                      Ocean Freight Service Functions <br /> by Bestech
                    </Link>
                  </h2>
                  <p>
                    Packages and web page editors now use Lorem Ipsum as their

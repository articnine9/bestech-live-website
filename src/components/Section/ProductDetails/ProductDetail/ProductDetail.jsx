              ...
              <div className="blog-standard-page__single">
                ...
                <div className="blog-standard-page__single-content">
                  <ul className="meta-box">
                    <li>
                      <Link href="blog">
                        <i className="icon-user1"></i> By admin
                      </Link>
                    </li>
                    <li>
                      <Link href="blog">
                        <i className="icon-date"></i> March 27, 2023
                      </Link>
                    </li>
                    <li>
                      <Link href="blog-details">
                        <i className="icon-comments"></i> 03 Comments
                      </Link>
                    </li>
                    <li>
                      <Link href="blog">
                        <i className="icon-tag"></i> Air Freight
                      </Link>
                    </li>
                  </ul>
                  <h2>
                    <Link href="blog-details">
                      Advanced Service Functions by <br /> Ocean Transport
                    </Link>
                  </h2>
                  ...
                  <p>
                    ...
                    readable English. packages and web page editors now use
                  ...
                  <div className="blog-details__content-text1 text-center">
                    ...
                    <p>
                      “Readable and Packages editors now use Lorem Ipsum as
                      their default <br />
                      model textlayout point of using the some is that it has a
                      more”
                    </p>
                  ...
                  <div className="blog-details__content-text2">
                    <div className="title-box">
                      <h2>
                        Safest Logistics Solutions Provider <br /> With
                        Integrity
                      </h2>
                      <p>
                        Readable and Packages editors now use Lorem Ipsum as
                        their default model textlayout. The point of using the
                        some is that it has a more-or-less normal distribution
                    ...
                    <div className="blog-details__content-text2-img">
                      <div className="shape1">
                        <img src="/img/shape/blog-details-shape1.webp" alt="" />
                      </div>
                      ...
                      <div className="comment-one__single-inner">
                        <div className="comment-one__single-top">
                          <div className="author-box">
                            <div className="img-box">
                              <img
                                src="/img/blog/blog-details-img3.webp"
                                alt=""
                              />
                            </div>
                          ...
                          <div className="date-box">
                            <p>
                              <span className="icon-date"></span> 21April, 2023
                              - 08:30am
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="comment-one__single-bottom">
                          <p>
                            ...
                            their default model textlayout point of using are
                            Ipsum is that it has normal Packages.
                          </p>
                      ...
                      <div className="comment-one__single-inner">
                        <div className="comment-one__single-top">
                          <div className="author-box">
                            <div className="img-box">
                              <img
                                src="/img/blog/blog-details-img4.webp"
                                alt=""
                              />
                            </div>
                        ...
                        <div className="comment-one__single-bottom">
                          <p>
                            ...
                            more-or-less normal distribution of letters opposed
                            to using.{" "}
                      ...
                      <div className="row">
                        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                          <div className="contact-page__input-box">
                            <textarea
                              name="message"
                              placeholder="Wright your massage"
                            ></textarea>
                          </div>

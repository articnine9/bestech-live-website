              ...
              <div className="team-details__top-content">
                <div className="team-details__top-content-progress">
                  <div className="team-details__top-content-progress-single">
                    ...
                    <div className="bar">
                      <div
                        className="bar-inner count-bar-one"
                  ...
                  <div className="team-details__top-content-progress-single">
                    ...
                    <div className="bar">
                      <div
                        className="bar-inner count-bar-two"
                        style={{ width: `${successRateTwo}%` }}
                      >
                  ...
                  <div className="team-details__top-content-progress-single mb0">
                    ...
                    <div className="bar">
                      <div
                        className="bar-inner count-bar-three"
                        style={{ width: `${successRateThree}%` }}
                      >
          ...
          <div className="row">
            <div className="col-xl-6">
              <div className="team-details__bottom-content">
                <h2>Summary</h2>
                <h4>
                  Hello There, Established fact that a reader will be distracted
                  more-or-less normal distribution of letters
                </h4>
                <p>
                  It is a long established fact that a reader will be distracted
                  more-or-less normal distribution of letters, as opposed to
                  using content here content here, making it look readable
                  English packages and web page editors now use Lorem of Ipsum

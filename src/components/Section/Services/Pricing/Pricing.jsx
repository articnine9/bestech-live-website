              ...
              <div className="pricing-one__single text-center">
                ...
                <div className="table-content">
                  ...
                  <ul>
                    <li>
                      <p>
                        <span className="icon-check"></span>Single Truck
                      </p>
                    </li>
                    <li>
                      <p>
                        <span className="icon-check"></span>Full Insurance
                      </p>
                    </li>
                    <li>
                      <p>
                        <span className="icon-check"></span>500 Km
                      </p>
                    </li>
                    <li>
                      <p>
                        <span className="icon-check"></span>Real-time rate
                        shiping
                      </p>
                    </li>
                  </ul>
